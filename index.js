...
module.exports = plugin(
    function ({e, addBase, addComponents, addUtilities, matchUtilities, theme }) {
        ...
        addComponents({
            ".stripes": { "@apply relative overflow-hidden isolate": true },
            ".stripes:before": {
          ...
          transparent 5%,
          transparent 45%,
          var(--stripes-color) 45%,
          var(--stripes-color) 55%,
          transparent 55%,
          transparent 95%,
        ...
        addUtilities(Object.keys(themeColors)
            .reduce((stripes, key) => {
